import Chapter01_Woods as c1
from time import sleep


def Headless():
    print('"Human"\nYou are sickened by the melodious voice of the monster of the Headless Hunt.\n"Keep your spirit calm and body clean for the Hunt draws near."\n')
    sleep(3.0)
